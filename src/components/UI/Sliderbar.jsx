    ...
    <>
      <aside
        ...
        <div
          ...
          className="-right-6 cursor-pointer transition transform ease-in-out duration-500 flex border-4 border-white dark:border-[#0F172A] bg-[#1E293B] dark:hover:bg-blue-500 hover:bg-purple-500 absolute top-2 p-3 rounded-full text-white hover:rotate-45">
          <svg
        ...
        <div
          ...
          <Link
            ...
            <div className=" cursor-pointer">Proyectos</div>
          </Link>
          <Link
            href="/analitica"
            className="hover:ml-4 w-full text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
            ...
            <div className=" cursor-pointer">Analitica</div>
          </Link>
        </div>
        <div
